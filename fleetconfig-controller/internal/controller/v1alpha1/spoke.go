...
func handleSpokes(ctx context.Context, kClient client.Client, fc *v1alpha1.FleetConfig) error {
	...
	for _, spoke := range fc.Spec.Spokes {
		...
		if managedCluster == nil {
			tokenMeta, err := getToken(ctx, kClient, fc, hubKubeconfig)
			if err != nil {
...
func getToken(ctx context.Context, kClient client.Client, fc *v1alpha1.FleetConfig, hubKubeconfig []byte) (*tokenMeta, error) {
	logger := log.FromContext(ctx)
	...
	tokenArgs, cleanupKcfg, err := common.PrepareKubeconfig(ctx, kClient, hubKubeconfig, fc.Spec.Hub.Kubeconfig.Context, tokenArgs)
	if cleanupKcfg != nil {
		defer cleanupKcfg()
	}
	if err != nil {
...
func joinSpoke(ctx context.Context, kClient client.Client, fc *v1alpha1.FleetConfig, spoke v1alpha1.Spoke, tokenMeta *tokenMeta) error {
	...
	joinArgs, cleanupKcfg, err := common.PrepareKubeconfig(ctx, kClient, kubeconfig, spoke.Kubeconfig.Context, joinArgs)
	if cleanupKcfg != nil {
		defer cleanupKcfg()
	}
	if err != nil {
...
func upgradeSpoke(ctx context.Context, kClient client.Client, fc *v1alpha1.FleetConfig, spoke v1alpha1.Spoke) error {
	...
	upgradeArgs, cleanupKcfg, err := common.PrepareKubeconfig(ctx, kClient, kubeconfig, spoke.Kubeconfig.Context, upgradeArgs)
	if cleanupKcfg != nil {
		defer cleanupKcfg()
	}
	if err != nil {
...
func unjoinSpoke(ctx context.Context, kClient client.Client, fc *v1alpha1.FleetConfig, spoke v1alpha1.ISpoke) error {
	...
	unjoinArgs, cleanupKcfg, err := common.PrepareKubeconfig(ctx, kClient, kubeconfig, spoke.GetKubeconfig().Context, unjoinArgs)
	if cleanupKcfg != nil {
		defer cleanupKcfg()
	}
	if err != nil {

...
tmp_dir="$(mktemp -d)"
ocm_asset_dir="api-$OCM_API_VERSION"
...
# ocm
wget "https://github.com/open-cluster-management-io/api/archive/refs/tags/v$OCM_API_VERSION.tar.gz" -O "$tmp_dir/$ocm_tarball"
